...
const INITIAL_AGENT_STATE: AgentMetrics[] = [
  ...
  {
    role: 'EDGE',
    name: 'Edge Device Integrity Monitor',
    status: 'IDLE',
    model: 'gemini-2.0-flash',
    queueLength: 0,
    healthPercent: 91,
  ...
  {
    role: 'FUSION_ENGINE',
    name: 'Bayesian Fusion Engine',
    status: 'IDLE',
    model: 'deterministic-bayesian',
    queueLength: 0,
    healthPercent: 100,
    latencyMs: 12,
    memoryUsageMb: 80,
    ...
    uptimePercent: 100,
    lastExecution: new Date().toISOString(),
    description: 'Weighted Bayesian log-odds fusion of all agent evidence. Computes posterior probability, dissent, expected utility.',
  },
];
